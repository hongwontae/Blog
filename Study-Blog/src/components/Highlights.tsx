...
function Highlights() {
  return (
    <>
      <div className="w-8/12 h-[19rem] text-center text-white flex flex-col justify-end">
        <div className="flex flex-col h-full justify-between">
          <h1 className="text-highlight font-semibold text-[1.8rem] mb-4">
            Highlights
          </h1>
          <div className="flex flex-row gap-8">
            <motion.section
              className="w-full h-[15rem] rounded-2xl border-1 border-border-color overflow-hidden"
